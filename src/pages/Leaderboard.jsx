      ...
      <Box sx={{ maxWidth: 1600, mx: 'auto', px: 4, py: 6, position: 'relative', zIndex: 1 }}>
        ...
        {!loading && (
          <Grid container spacing={4}>
            ...
            {/* Top Event Attendees - Full Width, above Sources/Destinations */}
            <Grid item xs={12}>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  <ModernProgressSection
                    ...
                    icon={<MyLocation />}
                    items={data?.topSources.slice(0, 10) || []}
                    color="info"
                    delay={200}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <ModernProgressSection
                    ...
                    icon={<LocationOn />}
                    items={data?.topDestinations.slice(0, 10) || []}
                    color="success"
                    delay={400}
                  />
                </Grid>
            ...
            {/* Driver Rankings Table - Full Width */}
            <Grid item xs={12}>
